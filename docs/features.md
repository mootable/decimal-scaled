...
```toml
[dependencies]
decimal-scaled = { version = "0.3.1", default-features = false, features = ["alloc"] }
```
...
decimal-scaled = { version = "0.3.1", features = ["wide", "macros"] }

# Add the extra-wide tiers (D461 / D615) on top of wide.
decimal-scaled = { version = "0.3.1", features = ["x-wide", "macros"] }

# Add the xx-wide tiers (D923 / D1231) — research-grade precision.
decimal-scaled = { version = "0.3.1", features = ["xx-wide", "macros"] }
