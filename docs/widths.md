...
<<<<<<< HEAD
  `D1232<1231>` cost <!-- BEGIN GENERATED:widths:slowest -->at most ~5.25 µs per call (the slowest cell measured anywhere on the surface: `acosh` at `D18<9>`)<!-- END GENERATED:widths:slowest -->, so it's
=======
