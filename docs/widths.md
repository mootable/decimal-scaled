...
<<<<<<< HEAD
  `D1232<1231>` cost <!-- BEGIN GENERATED:widths:slowest -->at most ~5.57 ms per call (the slowest cell measured anywhere on the surface: `atanh` at `D1232<1231>`)<!-- END GENERATED:widths:slowest -->, so it's
=======
