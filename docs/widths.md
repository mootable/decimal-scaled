...
<<<<<<< HEAD
  `D1232<1231>` cost <!-- BEGIN GENERATED:widths:slowest -->at most ~9.02 ms per call (the slowest cell measured anywhere on the surface: `powf@hard` at `D1232<1231>`)<!-- END GENERATED:widths:slowest -->, so it's
=======
