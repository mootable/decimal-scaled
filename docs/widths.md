...
<<<<<<< HEAD
  `D1232<1231>` cost <!-- BEGIN GENERATED:widths:slowest -->at most ~2.68 ms per call (the slowest cell measured anywhere on the surface: `exp` at `D1232<1231>`)<!-- END GENERATED:widths:slowest -->, so it's
=======
