...
big set of known-correct answers (the *golden* values — <!-- BEGIN GENERATED:golden:counts -->103,174 answers across 30 functions<!-- END GENERATED:golden:counts -->) and the machinery to check
