...
big set of known-correct answers (the *golden* values — <!-- BEGIN GENERATED:golden:counts -->102,774 answers across 30 functions<!-- END GENERATED:golden:counts -->) and the machinery to check
