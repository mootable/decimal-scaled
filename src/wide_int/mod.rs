...
//! - **`macros`** — the `decl_hint!` macro: emits a concrete
...
decl_hint!(Uint256, Int256, 2, 4);
decl_hint!(Uint512, Int512, 4, 8);
decl_hint!(Uint1024, Int1024, 8, 16);
decl_hint!(Uint2048, Int2048, 16, 32);
decl_hint!(Uint4096, Int4096, 32, 64);
