...
pub(crate) fn pi_at_target_d256<const TARGET: u32>() -> Int256 {
    ...
    D76::<D256_SCALE_REF>::from_bits(PI_RAW_D256)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d76", feature = "wide"))]
pub(crate) fn tau_at_target_d256<const TARGET: u32>() -> Int256 {
    use crate::core_type::D76;
    D76::<D256_SCALE_REF>::from_bits(TAU_RAW_D256)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d76", feature = "wide"))]
pub(crate) fn half_pi_at_target_d256<const TARGET: u32>() -> Int256 {
    use crate::core_type::D76;
    D76::<D256_SCALE_REF>::from_bits(HALF_PI_RAW_D256)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d76", feature = "wide"))]
pub(crate) fn quarter_pi_at_target_d256<const TARGET: u32>() -> Int256 {
    use crate::core_type::D76;
    D76::<D256_SCALE_REF>::from_bits(QUARTER_PI_RAW_D256)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d76", feature = "wide"))]
pub(crate) fn e_at_target_d256<const TARGET: u32>() -> Int256 {
    use crate::core_type::D76;
    D76::<D256_SCALE_REF>::from_bits(E_RAW_D256)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d76", feature = "wide"))]
pub(crate) fn golden_at_target_d256<const TARGET: u32>() -> Int256 {
    use crate::core_type::D76;
    D76::<D256_SCALE_REF>::from_bits(GOLDEN_RAW_D256)
        .rescale::<TARGET>()
        .to_bits()
}
...
pub(crate) fn pi_at_target_d512<const TARGET: u32>() -> Int512 {
    ...
    D153::<D512_SCALE_REF>::from_bits(PI_RAW_D512)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d153", feature = "wide"))]
pub(crate) fn tau_at_target_d512<const TARGET: u32>() -> Int512 {
    use crate::core_type::D153;
    D153::<D512_SCALE_REF>::from_bits(TAU_RAW_D512)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d153", feature = "wide"))]
pub(crate) fn half_pi_at_target_d512<const TARGET: u32>() -> Int512 {
    use crate::core_type::D153;
    D153::<D512_SCALE_REF>::from_bits(HALF_PI_RAW_D512)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d153", feature = "wide"))]
pub(crate) fn quarter_pi_at_target_d512<const TARGET: u32>() -> Int512 {
    use crate::core_type::D153;
    D153::<D512_SCALE_REF>::from_bits(QUARTER_PI_RAW_D512)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d153", feature = "wide"))]
pub(crate) fn e_at_target_d512<const TARGET: u32>() -> Int512 {
    use crate::core_type::D153;
    D153::<D512_SCALE_REF>::from_bits(E_RAW_D512)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d153", feature = "wide"))]
pub(crate) fn golden_at_target_d512<const TARGET: u32>() -> Int512 {
    use crate::core_type::D153;
    D153::<D512_SCALE_REF>::from_bits(GOLDEN_RAW_D512)
        .rescale::<TARGET>()
        .to_bits()
}
...
pub(crate) fn pi_at_target_d1024<const TARGET: u32>() -> Int1024 {
    ...
    D307::<D1024_SCALE_REF>::from_bits(PI_RAW_D1024)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d307", feature = "wide"))]
pub(crate) fn tau_at_target_d1024<const TARGET: u32>() -> Int1024 {
    use crate::core_type::D307;
    D307::<D1024_SCALE_REF>::from_bits(TAU_RAW_D1024)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d307", feature = "wide"))]
pub(crate) fn half_pi_at_target_d1024<const TARGET: u32>() -> Int1024 {
    use crate::core_type::D307;
    D307::<D1024_SCALE_REF>::from_bits(HALF_PI_RAW_D1024)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d307", feature = "wide"))]
pub(crate) fn quarter_pi_at_target_d1024<const TARGET: u32>() -> Int1024 {
    use crate::core_type::D307;
    D307::<D1024_SCALE_REF>::from_bits(QUARTER_PI_RAW_D1024)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d307", feature = "wide"))]
pub(crate) fn e_at_target_d1024<const TARGET: u32>() -> Int1024 {
    use crate::core_type::D307;
    D307::<D1024_SCALE_REF>::from_bits(E_RAW_D1024)
        .rescale::<TARGET>()
        .to_bits()
}
#[cfg(any(feature = "d307", feature = "wide"))]
pub(crate) fn golden_at_target_d1024<const TARGET: u32>() -> Int1024 {
    use crate::core_type::D307;
    D307::<D1024_SCALE_REF>::from_bits(GOLDEN_RAW_D1024)
        .rescale::<TARGET>()
        .to_bits()
}
