//! Bespoke square-root kernel slot for `D56<20>`.
//!
//! Currently a thin pass-through to [`super::generic_wide::sqrt_d56`] —
//! byte-identical output, identical cost. This file exists so the
//! [`crate::policy::sqrt`] override for `D56<20>` has a stable callee
