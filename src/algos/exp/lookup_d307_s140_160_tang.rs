...
pub(crate) fn tang_exp_fixed(v_w: core::W, w: u32) -> core::W {
    ...
    debug_assert!(j_idx < M, "tang_exp_fixed d307 s140..=160: table index out of range");
...
#[inline]
#[must_use]
pub(crate) fn exp_strict<const SCALE: u32>(raw: Int1024, mode: RoundingMode) -> Int1024 {
    if raw == Int1024::ZERO {
