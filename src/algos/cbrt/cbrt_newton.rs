    ...
    Int<N>: ComputeInt,
{
    ...
    let mut len = s;
    let mut tmp_buf = Int::<N>::quad_buffered_u64();
...
where
    Int<N>: ComputeInt,
{
    let mut sq_buf = Int::<N>::quad_buffered_u64();
