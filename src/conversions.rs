...
// `From<integer>` for D128 is emitted by the shared
// `decl_from_primitive!` macro (see `core_type.rs` for the
// invocations). The bodies are identical to what was previously
// hand-coded here.
