...
impl<const SCALE: u32> One for D128<SCALE> {
    ...
    /// use num_traits::One;
    ///
    /// assert_eq!(D128e12::one(), D128e12::ONE);
    /// ```
    #[inline]
    fn one() -> Self {
        Self::ONE
    ...
    /// use num_traits::One;
    ///
    /// assert!(D128e12::ONE.is_one());
    /// assert!(!D128e12::ZERO.is_one());
    /// ```
    #[inline]
    fn is_one(&self) -> bool {
...
impl<const SCALE: u32> Num for D128<SCALE> {
    ...
    /// use num_traits::Num;
    ///
    /// let v = D128e12::from_str_radix("1", 10).expect("parse 1");
    /// assert_eq!(v, D128e12::ONE);
    ///
    /// assert!(D128e12::from_str_radix("1", 16).is_err());
    /// ```
...
impl<const SCALE: u32> Bounded for D128<SCALE> {
    ...
    ///
    /// assert_eq!(D128e12::min_value(), D128e12::MIN);
    /// ```
    #[inline]
    fn min_value() -> Self {
        Self::MIN
    ...
    /// use num_traits::Bounded;
    ///
    /// assert_eq!(D128e12::max_value(), D128e12::MAX);
    /// ```
    #[inline]
    fn max_value() -> Self {
        Self::MAX
...
impl<const SCALE: u32> Signed for D128<SCALE> {
    ...
    /// use num_traits::Signed;
    ///
    /// assert_eq!(D128e12::from_bits(5).signum(), D128e12::ONE);
    /// assert_eq!(D128e12::from_bits(-5).signum(), -D128e12::ONE);
    ...
    /// let five = D128e12::from_bits(5_000_000_000_000);
    /// let three = D128e12::from_bits(3_000_000_000_000);
    ///
    /// assert_eq!(five.abs_sub(&two), three);
    /// assert_eq!(two.abs_sub(&five), D128e12::ZERO);
    /// assert_eq!(five.abs_sub(&five), D128e12::ZERO);
    /// ```
    #[inline]
...
impl<const SCALE: u32> FromPrimitive for D128<SCALE> {
    ...
    ///
    /// assert_eq!(D128e12::from_i64(0), Some(D128e12::ZERO));
    /// assert_eq!(D128e12::from_i64(1), Some(D128e12::ONE));
    /// assert_eq!(D128e12::from_i64(-42), Some(D128e12::from_bits(-42_000_000_000_000)));
    /// ```
    #[inline]
    ...
    /// use num_traits::FromPrimitive;
    ///
    /// assert_eq!(D128e12::from_u64(0), Some(D128e12::ZERO));
    /// assert_eq!(D128e12::from_u64(42), Some(D128e12::from_bits(42_000_000_000_000)));
    /// ```
    #[inline]
    ...
    /// use num_traits::FromPrimitive;
    ///
    /// assert_eq!(D128e12::from_i128(7), Some(D128e12::from_bits(7_000_000_000_000)));
    /// assert_eq!(D128e12::from_i128(i128::MAX), None);
    /// ```
    #[inline]
    ...
    /// use num_traits::FromPrimitive;
    ///
    /// assert_eq!(D128e12::from_u128(99), Some(D128e12::from_bits(99_000_000_000_000)));
    /// assert_eq!(D128e12::from_u128(u128::MAX), None);
    /// ```
    #[inline]
    ...
    /// use num_traits::FromPrimitive;
    ///
    /// assert_eq!(D128e12::from_f32(0.0), Some(D128e12::ZERO));
    /// assert_eq!(D128e12::from_f32(1.0), Some(D128e12::ONE));
    /// assert_eq!(D128e12::from_f32(f32::NAN), None);
    /// assert_eq!(D128e12::from_f32(f32::INFINITY), None);
    /// ```
    #[inline]
    ...
    /// use num_traits::FromPrimitive;
    ///
    /// assert_eq!(D128e12::from_f64(0.0), Some(D128e12::ZERO));
    /// assert_eq!(D128e12::from_f64(1.0), Some(D128e12::ONE));
    /// assert_eq!(D128e12::from_f64(f64::NAN), None);
    /// assert_eq!(D128e12::from_f64(1e30), None);
    /// ```
    #[inline]
...
impl<const SCALE: u32> ToPrimitive for D128<SCALE> {
    ...
    ///
    /// let v = D128e12::from_bits(2_500_000_000_000); // 2.5
    /// assert_eq!(v.to_i64(), Some(2));
    /// assert_eq!(D128e12::MAX.to_i64(), None);
    /// ```
    #[inline]
    ...
    /// use num_traits::ToPrimitive;
    ///
    /// let v = D128e12::from_bits(42_000_000_000_000);
    /// assert_eq!(v.to_u64(), Some(42));
    /// assert_eq!((-D128e12::ONE).to_u64(), None);
    /// ```
    #[inline]
    ...
    /// assert!(D128e12::MAX.to_i128().is_some());
    /// ```
    #[inline]
    ...
    /// use num_traits::ToPrimitive;
    ///
    /// assert_eq!(D128e12::ZERO.to_u128(), Some(0));
    /// assert_eq!(D128e12::from_bits(-1).to_u128(), None);
    /// ```
    #[inline]
    ...
    /// use num_traits::ToPrimitive;
    ///
    /// let v = D128e12::from_bits(1_500_000_000_000); // 1.5
...
impl<const SCALE: u32> NumCast for D128<SCALE> {
    ...
    ///
    /// let from_int: D128e12 = NumCast::from(42_i32).unwrap();
    /// assert_eq!(from_int, D128e12::from_bits(42_000_000_000_000));
    ///
    /// let from_float: D128e12 = NumCast::from(1.5_f64).unwrap();
    /// assert_eq!(from_float, D128e12::from_f64_lossy(1.5));
    ///
    /// let nan: Option<D128e12> = NumCast::from(f64::NAN);
    /// assert!(nan.is_none());
    /// ```
    #[inline]
...
impl<const SCALE: u32> CheckedRem for D128<SCALE> {
    ...
    /// let expected = D128e12::from_bits(1_500_000_000_000); // 1.5
    /// assert_eq!(a.checked_rem(b), Some(expected));
    /// assert_eq!(a.checked_rem(D128e12::ZERO), None);
    /// ```
    #[inline]
...
mod tests {
    ...
    fn zero_is_zero_const() {
        assert_eq!(<D128e12 as Zero>::zero(), D128e12::ZERO);
    }

    #[test]
    fn zero_is_zero_predicate() {
        assert!(<D128e12 as Zero>::is_zero(&D128e12::ZERO));
        assert!(!<D128e12 as Zero>::is_zero(&D128e12::ONE));
        assert!(!<D128e12 as Zero>::is_zero(&D128e12::from_bits(1)));
    }

    #[test]
    fn one_is_one_const() {
        assert_eq!(<D128e12 as One>::one(), D128e12::ONE);
    }

    #[test]
    fn one_is_one_predicate() {
        assert!(<D128e12 as One>::is_one(&D128e12::ONE));
        assert!(!<D128e12 as One>::is_one(&D128e12::ZERO));
        // A non-canonical raw value (1 LSB) is not "one".
        assert!(!<D128e12 as One>::is_one(&D128e12::from_bits(1)));
    }
    ...
    #[test]
    fn bounded_min_max() {
        assert_eq!(<D128e12 as Bounded>::min_value(), D128e12::MIN);
        assert_eq!(<D128e12 as Bounded>::max_value(), D128e12::MAX);
    }
    ...
    fn signed_abs_basic() {
        let pos = D128e12::from_bits(1_500_000_000_000);
        let neg = D128e12::from_bits(-1_500_000_000_000);
        assert_eq!(<D128e12 as Signed>::abs(&pos), pos);
        assert_eq!(<D128e12 as Signed>::abs(&neg), pos);
        assert_eq!(<D128e12 as Signed>::abs(&D128e12::ZERO), D128e12::ZERO);
    }
    ...
    fn signed_signum_basic() {
        let pos = D128e12::from_bits(1_500_000_000_000);
        let neg = D128e12::from_bits(-1_500_000_000_000);
        assert_eq!(<D128e12 as Signed>::signum(&pos), D128e12::ONE);
        assert_eq!(<D128e12 as Signed>::signum(&neg), -D128e12::ONE);
        assert_eq!(<D128e12 as Signed>::signum(&D128e12::ZERO), D128e12::ZERO);
    }
    ...
    fn signed_is_positive_negative() {
        let pos = D128e12::from_bits(1_500_000_000_000);
        let neg = D128e12::from_bits(-1_500_000_000_000);
        assert!(<D128e12 as Signed>::is_positive(&pos));
        assert!(!<D128e12 as Signed>::is_positive(&neg));
        assert!(!<D128e12 as Signed>::is_positive(&D128e12::ZERO));

        assert!(!<D128e12 as Signed>::is_negative(&pos));
        assert!(<D128e12 as Signed>::is_negative(&neg));
        assert!(!<D128e12 as Signed>::is_negative(&D128e12::ZERO));
    }
    ...
    fn signed_abs_sub_clamps_to_zero() {
        ...
        // 5 - 2 = 3 (positive case)
        let three = D128e12::from_bits(3_000_000_000_000);
        assert_eq!(<D128e12 as Signed>::abs_sub(&five, &two), three);

        // 2 - 5 clamps to ZERO (a <= b)
        assert_eq!(<D128e12 as Signed>::abs_sub(&two, &five), D128e12::ZERO);

        // 5 - 5 = ZERO (equal inputs)
        assert_eq!(<D128e12 as Signed>::abs_sub(&five, &five), D128e12::ZERO);
    }
    ...
    fn from_primitive_i64_in_range() {
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i64(0),
            Some(D128e12::ZERO)
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i64(1),
            Some(D128e12::ONE)
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i64(42),
            Some(D128e12::from_bits(42_000_000_000_000))
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i64(-42),
            Some(D128e12::from_bits(-42_000_000_000_000))
    ...
    fn from_primitive_u64_in_range() {
        assert_eq!(
            <D128e12 as FromPrimitive>::from_u64(0),
            Some(D128e12::ZERO)
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_u64(42),
            Some(D128e12::from_bits(42_000_000_000_000))
        );
        // u64::MAX * 10^12 fits in i128, so this succeeds.
        let large = <D128e12 as FromPrimitive>::from_u64(u64::MAX);
    ...
    fn from_primitive_i128_overflow_returns_none() {
        ...
        assert_eq!(<D128e12 as FromPrimitive>::from_i128(i128::MAX), None);
        assert_eq!(<D128e12 as FromPrimitive>::from_i128(i128::MIN), None);

        // Small values succeed.
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i128(7),
            Some(D128e12::from_bits(7_000_000_000_000))
        );
    }
    ...
    fn from_primitive_u128_overflow_returns_none() {
        ...
        assert_eq!(<D128e12 as FromPrimitive>::from_u128(u128::MAX), None);

        // Small values succeed.
        assert_eq!(
            <D128e12 as FromPrimitive>::from_u128(99),
            Some(D128e12::from_bits(99_000_000_000_000))
        );
    }
    ...
    fn from_primitive_f32_basic() {
        assert_eq!(
            <D128e12 as FromPrimitive>::from_f32(0.0),
            Some(D128e12::ZERO)
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_f32(1.0),
            Some(D128e12::ONE)
        );
        // Non-finite inputs return None.
        assert_eq!(<D128e12 as FromPrimitive>::from_f32(f32::NAN), None);
        assert_eq!(<D128e12 as FromPrimitive>::from_f32(f32::INFINITY), None);
        assert_eq!(<D128e12 as FromPrimitive>::from_f32(f32::NEG_INFINITY), None);
    }

    #[test]
    fn from_primitive_f64_basic() {
        assert_eq!(
            <D128e12 as FromPrimitive>::from_f64(0.0),
            Some(D128e12::ZERO)
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_f64(1.0),
            Some(D128e12::ONE)
        );
        // Use a value that is not close to any well-known math constant
        // so the approx_constant lint stays quiet.
        let v = <D128e12 as FromPrimitive>::from_f64(1.234567890123_f64);
        assert!(v.is_some());

        // Non-finite inputs return None.
        assert_eq!(<D128e12 as FromPrimitive>::from_f64(f64::NAN), None);
        assert_eq!(<D128e12 as FromPrimitive>::from_f64(f64::INFINITY), None);

        // Finite but out-of-range: 1e30 * 10^12 = 1e42 > i128::MAX.
        assert_eq!(<D128e12 as FromPrimitive>::from_f64(1e30), None);
    }
    ...
    fn from_primitive_smaller_int_types_via_default_impl() {
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i32(7),
            Some(D128e12::from_bits(7_000_000_000_000))
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i16(-3),
            Some(D128e12::from_bits(-3_000_000_000_000))
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_i8(0),
            Some(D128e12::ZERO)
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_u32(7),
            Some(D128e12::from_bits(7_000_000_000_000))
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_u16(3),
            Some(D128e12::from_bits(3_000_000_000_000))
        );
        assert_eq!(
            <D128e12 as FromPrimitive>::from_u8(255),
            Some(D128e12::from_bits(255_000_000_000_000))
        );
    }
    ...
    fn to_primitive_i64_in_range() {
        let v = D128e12::from_bits(42_000_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&v), Some(42_i64));

        let neg = D128e12::from_bits(-42_000_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&neg), Some(-42_i64));

        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&D128e12::ZERO), Some(0_i64));
    }

    #[test]
    fn to_primitive_i64_truncates_toward_zero() {
        // 2.5 truncates to 2
        let v = D128e12::from_bits(2_500_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&v), Some(2_i64));

        // -2.5 truncates to -2 (toward zero, not toward -inf)
        let neg = D128e12::from_bits(-2_500_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&neg), Some(-2_i64));
    }

    #[test]
    fn to_primitive_i64_out_of_range_returns_none() {
        // D128::MAX integer part ~= 1.7e26, which exceeds i64::MAX.
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&D128e12::MAX), None);
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&D128e12::MIN), None);
    }

    #[test]
    fn to_primitive_u64_negative_returns_none() {
        let neg = D128e12::from_bits(-1_000_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_u64(&neg), None);
    }

    #[test]
    fn to_primitive_u64_in_range() {
        let v = D128e12::from_bits(42_000_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_u64(&v), Some(42_u64));

        assert_eq!(<D128e12 as ToPrimitive>::to_u64(&D128e12::ZERO), Some(0_u64));
    }
    ...
    fn to_primitive_i128_always_succeeds() {
        ...
        assert!(<D128e12 as ToPrimitive>::to_i128(&D128e12::MAX).is_some());
        assert!(<D128e12 as ToPrimitive>::to_i128(&D128e12::MIN).is_some());
        assert_eq!(
            <D128e12 as ToPrimitive>::to_i128(&D128e12::ZERO),
            Some(0_i128)
        );
        assert_eq!(
            <D128e12 as ToPrimitive>::to_i128(&D128e12::from_bits(42_000_000_000_000)),
            Some(42_i128)
        );
    }
    ...
    fn to_primitive_u128_negative_returns_none() {
        assert_eq!(
            <D128e12 as ToPrimitive>::to_u128(&D128e12::from_bits(-1)),
            None
        );
    }
    ...
    fn to_primitive_u128_in_range() {
        assert_eq!(
            <D128e12 as ToPrimitive>::to_u128(&D128e12::ZERO),
            Some(0_u128)
        );
        assert_eq!(
            <D128e12 as ToPrimitive>::to_u128(&D128e12::from_bits(99_000_000_000_000)),
            Some(99_u128)
        );
    }
    ...
    fn to_primitive_f64_round_trip_within_lsb() {
        ...
        let v = D128e12::from_f64_lossy(1.234567890123_f64);
        let back = <D128e12 as ToPrimitive>::to_f64(&v).expect("to_f64 always returns Some");
        assert!(
    ...
    fn to_primitive_f32_matches_to_f32_lossy() {
        ...
        assert_eq!(
            <D128e12 as ToPrimitive>::to_f32(&v),
            Some(v.to_f32_lossy())
        );
    }
    ...
    fn to_primitive_smaller_int_types_via_default_impl() {
        let v = D128e12::from_bits(42_000_000_000_000);
        assert_eq!(<D128e12 as ToPrimitive>::to_i32(&v), Some(42_i32));
        assert_eq!(<D128e12 as ToPrimitive>::to_u32(&v), Some(42_u32));
        assert_eq!(<D128e12 as ToPrimitive>::to_i16(&v), Some(42_i16));
        assert_eq!(<D128e12 as ToPrimitive>::to_u16(&v), Some(42_u16));
        assert_eq!(<D128e12 as ToPrimitive>::to_i8(&v), Some(42_i8));
        assert_eq!(<D128e12 as ToPrimitive>::to_u8(&v), Some(42_u8));

        // Out-of-range narrowing returns None.
        let big = D128e12::from_bits(40_000_000_000_000_000); // 40_000
        assert_eq!(<D128e12 as ToPrimitive>::to_i8(&big), None);
        assert_eq!(<D128e12 as ToPrimitive>::to_u8(&big), None);
    }
    ...
    fn checked_add_basic() {
        ...
        let two = D128e12::from_bits(2_000_000_000_000);
        assert_eq!(
            <D128e12 as CheckedAdd>::checked_add(&one, &one),
            Some(two)
        );
    }
    ...
    fn checked_add_overflow_returns_none() {
        // MAX + ONE overflows.
        assert_eq!(
            <D128e12 as CheckedAdd>::checked_add(&D128e12::MAX, &D128e12::ONE),
            None
        );
        // MAX + ZERO is fine.
        assert_eq!(
            <D128e12 as CheckedAdd>::checked_add(&D128e12::MAX, &D128e12::ZERO),
            Some(D128e12::MAX)
        );
    }
    ...
    fn checked_sub_basic() {
        ...
        let two = D128e12::from_bits(2_000_000_000_000);
        assert_eq!(
            <D128e12 as CheckedSub>::checked_sub(&three, &two),
            Some(D128e12::ONE)
        );
    }
    ...
    fn checked_sub_underflow_returns_none() {
        // MIN - ONE underflows.
        assert_eq!(
            <D128e12 as CheckedSub>::checked_sub(&D128e12::MIN, &D128e12::ONE),
            None
        );
    }
    ...
    fn checked_mul_basic() {
        ...
        assert_eq!(
            <D128e12 as CheckedMul>::checked_mul(&half, &half),
            Some(quarter)
        );
    }
    ...
    fn checked_mul_overflow_returns_none() {
        ...
        let two = D128e12::from_bits(2_000_000_000_000);
        assert_eq!(
            <D128e12 as CheckedMul>::checked_mul(&D128e12::MAX, &two),
            None
        );
    }
    ...
    fn checked_div_basic() {
        ...
        // 0.5 / 2.0 == 0.25
        assert_eq!(
            <D128e12 as CheckedDiv>::checked_div(&half, &two),
            Some(quarter)
        );
    }
    ...
    fn checked_div_by_zero_returns_none() {
        assert_eq!(
            <D128e12 as CheckedDiv>::checked_div(&D128e12::ONE, &D128e12::ZERO),
            None
        );
    }
    ...
    fn checked_div_overflow_returns_none() {
        ...
        assert_eq!(
            <D128e12 as CheckedDiv>::checked_div(&D128e12::MIN, &neg_one),
            None
        );
        // MAX / ONE returns Some(MAX) via the widening path.
        assert_eq!(
            <D128e12 as CheckedDiv>::checked_div(&D128e12::MAX, &D128e12::ONE),
            Some(D128e12::MAX)
        );
    }
    ...
    fn checked_rem_basic() {
        ...
        let expected = D128e12::from_bits(1_500_000_000_000); // 1.5
        assert_eq!(
            <D128e12 as CheckedRem>::checked_rem(&a, &b),
            Some(expected)
        );
    }
    ...
    fn checked_rem_by_zero_returns_none() {
        assert_eq!(
            <D128e12 as CheckedRem>::checked_rem(&D128e12::ONE, &D128e12::ZERO),
            None
        );
    }
    ...
    fn checked_neg_basic() {
        ...
        let neg_one = -D128e12::ONE;
        assert_eq!(
            <D128e12 as CheckedNeg>::checked_neg(&one),
            Some(neg_one)
        );
        assert_eq!(
            <D128e12 as CheckedNeg>::checked_neg(&D128e12::ZERO),
            Some(D128e12::ZERO)
        );
    }
    ...
    fn checked_neg_min_returns_none() {
        ...
        assert_eq!(
            <D128e12 as CheckedNeg>::checked_neg(&D128e12::MIN),
            None
        );
    }
    ...
    fn checked_mul_trait_matches_inherent_256_pairs() {
        ...
        for pair in seeds.chunks_exact(2) {
            let a = D128e12::from_bits(pair[0]);
            let b = D128e12::from_bits(pair[1]);
            let trait_result = <D128e12 as CheckedMul>::checked_mul(&a, &b);
    ...
    fn checked_div_trait_matches_inherent_256_pairs() {
        ...
        for pair in seeds.chunks_exact(2) {
            ...
            let b_bits = if pair[1] == 0 { D128e12::multiplier() } else { pair[1] };
            let b = D128e12::from_bits(b_bits);
            let trait_result = <D128e12 as CheckedDiv>::checked_div(&a, &b);
    ...
    fn checked_mul_trait_matches_inherent_boundary() {
        let cases: &[(D128e12, D128e12)] = &[
            (D128e12::MAX, D128e12::ZERO),
            (D128e12::MIN, D128e12::ZERO),
            (D128e12::MAX, D128e12::ONE),
            (D128e12::MIN, D128e12::ONE),
            (D128e12::MAX, D128e12::MAX),
            (D128e12::MIN, D128e12::MIN),
            (D128e12::from_bits(0), D128e12::from_bits(0)),
            (D128e12::from_bits(1), D128e12::from_bits(1)),
            (D128e12::from_bits(-1), D128e12::from_bits(1)),
            (D128e12::from_bits(1), D128e12::from_bits(-1)),
            (D128e12::from_bits(-1), D128e12::from_bits(-1)),
        ];
    ...
    fn checked_div_trait_matches_inherent_boundary() {
        ...
        let cases: &[(D128e12, D128e12)] = &[
            ...
            (D128e12::MAX, D128e12::MAX),
            (D128e12::MIN, D128e12::MIN),
            (D128e12::ZERO, D128e12::ONE),
            (D128e12::ONE, D128e12::MAX),
            // divide by zero — both must return None
            (D128e12::ONE, D128e12::ZERO),
            (D128e12::MAX, D128e12::ZERO),
    ...
    fn from_str_radix_non_ten_returns_invalid() {
        let result = <D128e12 as Num>::from_str_radix("1", 16);
        assert!(result.is_err());

        let result_2 = <D128e12 as Num>::from_str_radix("1", 2);
    ...
    fn from_str_radix_base_ten_delegates_to_from_str() {
        let parsed = <D128e12 as Num>::from_str_radix("1", 10).expect("parse 1");
        assert_eq!(parsed, D128e12::ONE);
    }
    ...
    #[test]
    fn numcast_from_i32() {
        let v: D128e12 = <D128e12 as NumCast>::from(42_i32).expect("in-range");
        assert_eq!(v, <D128e12 as From<i32>>::from(42_i32));
    }
    ...
    fn numcast_from_f64_preserves_fractional() {
        let v: D128e12 = <D128e12 as NumCast>::from(1.5_f64).expect("in-range");
        assert_eq!(v, D128e12::from_f64_lossy(1.5_f64));
    }

    /// `NumCast::from` returns `None` for `f64::NAN`.
    #[test]
    fn numcast_from_f64_nan_returns_none() {
        assert!(<D128e12 as NumCast>::from(f64::NAN).is_none());
    }

    /// `NumCast::from` returns `None` for finite out-of-range `f64`.
    #[test]
    fn numcast_from_f64_out_of_range_returns_none() {
        assert!(<D128e12 as NumCast>::from(1e30_f64).is_none());
    }
    ...
    fn numcast_from_i64_above_f64_mantissa_is_exact() {
        ...
        let v: i64 = 1_i64 << 54;
        let d: D128e12 = <D128e12 as NumCast>::from(v).expect("in-range");
        assert_eq!(<D128e12 as ToPrimitive>::to_i64(&d), Some(v));
    }
}
