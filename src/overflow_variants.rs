//! Overflow-aware arithmetic variants for [`D38`].
//!
//! Provides the standard Rust explicit-overflow method families as
//! inherent methods on [`D38<SCALE>`], covering six operations:
//!
...
mod tests {
    ...
    fn checked_mul_one_identity() {
        let v = D38s12::from_bits(7_500_000_000_000); // 7.5
    ...
    fn checked_matches_op_in_range() {
        let a = D38s12::from_bits(7_500_000_000_000); // 7.5
        let b = two();
