//! `ConvertError` Display / Debug strings — part of the public contract.

mod from_conversion_error_display {
    ...
    fn try_from_returns_overflow_message() {
        let r: Result<decimal_scaled::D18<2>, _> = i128::MAX.try_into();
        let e = r.unwrap_err();
    ...
    fn try_from_nan_returns_not_finite_message() {
        let r: Result<decimal_scaled::D18<2>, _> = f64::NAN.try_into();
        let e = r.unwrap_err();
