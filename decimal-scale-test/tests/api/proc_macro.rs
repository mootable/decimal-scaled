//! `d38!`-family proc-macro literal surface.
//! Migrated from `tests/macros.rs`.

#[cfg(feature = "macros")]
mod from_macros {
    //! Integration tests for the `d38!` proc-macro.
    //!
    //! See `macros/README.md` for the macro spec. This suite covers
    ...
    use decimal_scaled::{d38, D38s0, D38s12, D38s2, D38s5, D38s6, D38};
    ...
    fn auto_scale_inference_simple() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(123_i128).unwrap())
        );
    }
    ...
    fn auto_scale_inference_integer() {
        ...
        assert_eq!(
            v,
            D38s0::from_bits(decimal_scaled::Int::<2>::try_from(123_i128).unwrap())
        );
    }
    ...
    fn auto_scale_inference_zero_fractional() {
        ...
        assert_eq!(
            v,
            D38::<1>::from_bits(decimal_scaled::Int::<2>::try_from(10_i128).unwrap())
        );
    }
    ...
    fn auto_scale_inference_trailing_zero_preserved() {
        ...
        assert_eq!(
            v,
            D38::<3>::from_bits(decimal_scaled::Int::<2>::try_from(1230_i128).unwrap())
        );
    }
    ...
    fn auto_scale_inference_leading_zero_after_dot() {
        ...
        assert_eq!(
            v,
            D38::<3>::from_bits(decimal_scaled::Int::<2>::try_from(1_i128).unwrap())
        );
    }
    ...
    fn auto_scale_inference_with_underscores() {
        ...
        assert_eq!(
            v,
            D38s5::from_bits(decimal_scaled::Int::<2>::try_from(123_456_789_i128).unwrap())
        );
    }
    ...
    fn sci_simple() {
        ...
        assert_eq!(
            v,
            D38s0::from_bits(decimal_scaled::Int::<2>::try_from(1500_i128).unwrap())
        );
    }
    ...
    fn sci_negative_exponent() {
        ...
        assert_eq!(
            v,
            D38::<4>::from_bits(decimal_scaled::Int::<2>::try_from(15_i128).unwrap())
        );
    }
    ...
    fn sci_zero_exponent() {
        ...
        assert_eq!(
            v,
            D38::<1>::from_bits(decimal_scaled::Int::<2>::try_from(15_i128).unwrap())
        );
    }
    ...
    fn sci_integer_with_exponent() {
        ...
        assert_eq!(
            v,
            D38s0::from_bits(decimal_scaled::Int::<2>::try_from(1_000_000_i128).unwrap())
        );
    }
    ...
    fn sci_trailing_zero_mantissa() {
        ...
        assert_eq!(
            v,
            D38::<1>::from_bits(decimal_scaled::Int::<2>::try_from(1500_i128).unwrap())
        );
    }
    ...
    fn sci_negative_value() {
        ...
        assert_eq!(
            v,
            D38::<3>::from_bits(decimal_scaled::Int::<2>::try_from(-25_i128).unwrap())
        );
    }
    ...
    fn explicit_scale_up_pads_with_zeros() {
        ...
        assert_eq!(
            v,
            D38::<4>::from_bits(decimal_scaled::Int::<2>::try_from(12_300_i128).unwrap())
        );
    }
    ...
    fn explicit_scale_zero_on_integer() {
        ...
        assert_eq!(
            v,
            D38s0::from_bits(decimal_scaled::Int::<2>::try_from(42_i128).unwrap())
        );
    }
    ...
    fn explicit_scale_with_sci_notation() {
        ...
        assert_eq!(
            v,
            D38::<5>::from_bits(decimal_scaled::Int::<2>::try_from(150_000_000_i128).unwrap())
        );
    }
    ...
    fn rounded_half_to_even_above_half() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(124_i128).unwrap())
        );
    }
    ...
    fn rounded_half_to_even_exact_half_ties_to_even() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(122_i128).unwrap())
        );
    }
    ...
    fn financial_cents() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(50_i128).unwrap())
        );
    }
    ...
    fn satoshi_grade() {
        ...
        assert_eq!(
            v,
            D38::<8>::from_bits(decimal_scaled::Int::<2>::try_from(12_345_678_i128).unwrap())
        );
    }
    ...
    fn small_value_via_sci() {
        ...
        assert_eq!(
            v,
            D38::<9>::from_bits(decimal_scaled::Int::<2>::try_from(1_i128).unwrap())
        );
    }
    ...
    fn six_digit_micro() {
        ...
        assert_eq!(
            v,
            D38s6::from_bits(decimal_scaled::Int::<2>::try_from(1_234_567_i128).unwrap())
        );
    }
    ...
    fn expression_with_scale_factor() {
        ...
        assert_eq!(
            v,
            D38::<4>::from_bits(decimal_scaled::Int::<2>::try_from(50_000_i128).unwrap())
        );
    }
    ...
    fn expression_with_variable() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(4_200_i128).unwrap())
        );
    }
    ...
    fn expression_with_const() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(12_300_i128).unwrap())
        );
    }
    ...
    fn expression_function_call() {
        ...
        assert_eq!(
            v,
            D38s0::from_bits(decimal_scaled::Int::<2>::try_from(14_i128).unwrap())
        );
    }
    ...
    fn expression_negative_result() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(-500_i128).unwrap())
        );
    }
    ...
    fn expression_value_at_runtime() {
        ...
        assert_eq!(
            v,
            D38s2::from_bits(decimal_scaled::Int::<2>::try_from(12_600_i128).unwrap())
        );
    }
    ...
    fn d18_literal_inferred_scale() {
        ...
        assert_eq!(
            v,
            D18s4::from_bits(decimal_scaled::Int::<1>::from(12_345_678_i64))
        );
    }
    ...
    fn d18_explicit_scale_pad() {
        ...
        assert_eq!(
            v,
            D18s9::from_bits(decimal_scaled::Int::<1>::from(1_500_000_000_i64))
        );
    }
    ...
    fn d18_per_scale_wrapper_d18s12() {
        ...
        assert_eq!(
            v,
            D18s12::from_bits(decimal_scaled::Int::<1>::from(1_500_000_000_000_i64))
        );
    }
