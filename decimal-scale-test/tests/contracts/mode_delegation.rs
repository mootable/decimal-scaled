//! Rounding-mode delegation contracts (`*_strict` vs `*_strict_with(DEFAULT)`,
//! `*_approx` redirects, directed-mode bracketing).
//! Migrated from `tests/rounding_mode_matrix.rs`.
