...
cells! {
    ...
    D307<120> => 307, D307<153> => 307, D307<230> => 307, D307<306> => 307,
...
mod tests {
    ...
    fn cells_enumerates_every_band_edge() {
        // The 88 band-edge cells across the 12 widths; spot-check the count and edges.
