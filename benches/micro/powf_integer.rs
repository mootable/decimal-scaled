...
fn bench(c: &mut Criterion) {
    ...
    {
        type D = D38<19>;
        let base: D = D::from(2); // 2.0
        let exp_2: D = D::from(2);
        let exp_3: D = D::from(3);
        let exp_05: D = D::from(1) / D::from(2); // 0.5
        let exp_25: D = D::from(5) / D::from(2); // 2.5
    ...
    // ── D76<35> ────────────────────────────────────────────────────
    {
        ...
        let exp_2: D = D::from(2);
        let exp_3: D = D::from(3);
        let exp_05: D = D::from(1) / D::from(2);
        let exp_25: D = D::from(5) / D::from(2);
