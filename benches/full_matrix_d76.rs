...
fn bench_arith(c: &mut Criterion) {
    ...
    g.bench_function("bnum_d76_s35/add", |bn| {
        bn.iter(|| black_box(a) + black_box(b))
    });
    g.bench_function("bnum_d76_s35/sub", |bn| {
        bn.iter(|| black_box(a) - black_box(b))
    });
    g.bench_function("bnum_d76_s35/mul", |bn| {
        bn.iter(|| black_box(a) * black_box(b))
    });
    g.bench_function("bnum_d76_s35/div", |bn| {
        bn.iter(|| black_box(a) / black_box(b))
    });
    g.bench_function("bnum_d76_s35/rem", |bn| {
        bn.iter(|| black_box(a) % black_box(b))
    });
