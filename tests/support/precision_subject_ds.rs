...
impl PrecisionSubject for DecimalScaledSubject {
    ...
    fn eval(
        ...
        match width {
            ...
            Width::D18 if scale == 4 => eval_typed!(D18<4>, decimal_scaled::Int<1>, method, input, mode),
            Width::D18 if scale == 13 => eval_typed!(D18<13>, decimal_scaled::Int<1>, method, input, mode),
            ...
            Width::D38 if scale == 28 => eval_typed!(D38<28>, decimal_scaled::Int<2>, method, input, mode),
            ...
            Width::D57 if scale == 14 => eval_typed!(D57<14>, Int<3>, method, input, mode),
            ...
            Width::D57 if scale == 42 => eval_typed!(D57<42>, Int<3>, method, input, mode),
            ...
            Width::D76 if scale == 19 => eval_typed!(D76<19>, Int<4>, method, input, mode),
            Width::D76 if scale == 38 => eval_typed!(D76<38>, Int<4>, method, input, mode),
            Width::D76 if scale == 40 => eval_typed!(D76<40>, Int<4>, method, input, mode),
            Width::D76 if scale == 57 => eval_typed!(D76<57>, Int<4>, method, input, mode),
            Width::D76 if scale == 75 => eval_typed!(D76<75>, Int<4>, method, input, mode),
            Width::D76 => eval_typed!(D76<38>, Int<4>, method, input, mode),
            Width::D115 if scale == 0 => eval_typed!(D115<0>, Int<6>, method, input, mode),
            Width::D115 if scale == 28 => eval_typed!(D115<28>, Int<6>, method, input, mode),
            Width::D115 if scale == 50 => eval_typed!(D115<50>, Int<6>, method, input, mode),
            Width::D115 if scale == 57 => eval_typed!(D115<57>, Int<6>, method, input, mode),
            Width::D115 if scale == 86 => eval_typed!(D115<86>, Int<6>, method, input, mode),
            ...
            Width::D153 if scale == 38 => eval_typed!(D153<38>, Int<8>, method, input, mode),
            Width::D153 if scale == 76 => eval_typed!(D153<76>, Int<8>, method, input, mode),
            Width::D153 if scale == 114 => eval_typed!(D153<114>, Int<8>, method, input, mode),
            ...
            Width::D230 if scale == 57 => eval_typed!(D230<57>, Int<12>, method, input, mode),
            Width::D230 if scale == 115 => eval_typed!(D230<115>, Int<12>, method, input, mode),
            Width::D230 if scale == 172 => eval_typed!(D230<172>, Int<12>, method, input, mode),
            ...
            Width::D307 if scale == 76 => eval_typed!(D307<76>, Int<16>, method, input, mode),
            Width::D307 if scale == 120 => eval_typed!(D307<120>, Int<16>, method, input, mode),
            Width::D307 if scale == 153 => eval_typed!(D307<153>, Int<16>, method, input, mode),
            Width::D307 if scale == 230 => eval_typed!(D307<230>, Int<16>, method, input, mode),
            Width::D307 if scale == 306 => eval_typed!(D307<306>, Int<16>, method, input, mode),
            Width::D307 => eval_typed!(D307<153>, Int<16>, method, input, mode),
            ...
            Width::D462 if scale == 115 => eval_typed!(D462<115>, Int<24>, method, input, mode),
            Width::D462 if scale == 180 => eval_typed!(D462<180>, Int<24>, method, input, mode),
            Width::D462 if scale == 231 => eval_typed!(D462<231>, Int<24>, method, input, mode),
            Width::D462 if scale == 346 => eval_typed!(D462<346>, Int<24>, method, input, mode),
            Width::D462 if scale == 461 => eval_typed!(D462<461>, Int<24>, method, input, mode),
            Width::D462 => eval_typed!(D462<231>, Int<24>, method, input, mode),
            ...
            Width::D616 if scale == 154 => eval_typed!(D616<154>, Int<32>, method, input, mode),
            Width::D616 if scale == 240 => eval_typed!(D616<240>, Int<32>, method, input, mode),
            Width::D616 if scale == 308 => eval_typed!(D616<308>, Int<32>, method, input, mode),
            Width::D616 if scale == 462 => eval_typed!(D616<462>, Int<32>, method, input, mode),
            ...
            Width::D924 if scale == 231 => eval_typed!(D924<231>, Int<48>, method, input, mode),
            Width::D924 if scale == 350 => eval_typed!(D924<350>, Int<48>, method, input, mode),
            Width::D924 if scale == 462 => eval_typed!(D924<462>, Int<48>, method, input, mode),
            Width::D924 if scale == 693 => eval_typed!(D924<693>, Int<48>, method, input, mode),
            Width::D924 if scale == 923 => eval_typed!(D924<923>, Int<48>, method, input, mode),
            Width::D924 => eval_typed!(D924<462>, Int<48>, method, input, mode),
            ...
            Width::D1232 if scale == 308 => eval_typed!(D1232<308>, Int<64>, method, input, mode),
            Width::D1232 if scale == 470 => eval_typed!(D1232<470>, Int<64>, method, input, mode),
            Width::D1232 if scale == 616 => eval_typed!(D1232<616>, Int<64>, method, input, mode),
            Width::D1232 if scale == 924 => eval_typed!(D1232<924>, Int<64>, method, input, mode),
            Width::D1232 if scale == 1231 => eval_typed!(D1232<1231>, Int<64>, method, input, mode),
            Width::D1232 => eval_typed!(D1232<616>, Int<64>, method, input, mode),
        }
    }
}
